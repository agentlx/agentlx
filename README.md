...
```yaml
image: ghcr.io/agentlx/agentlx:v1.0.13@sha256:c71b5581f96d86253fcf947c8b4f6e4f6582685c2cbafd235c6870d595063b9f
```
...
sed -i 's|ghcr.io/agentlx/agentlx:v[0-9.]*|ghcr.io/agentlx/agentlx:v1.0.13|' docker-compose.yml
