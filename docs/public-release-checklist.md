...
```text
ghcr.io/agentlx/agentlx:v1.0.22
```
...
```text
ghcr.io/<owner>/agentlx:v1.0.22
ghcr.io/<owner>/agentlx:1.0.22
ghcr.io/<owner>/agentlx:1.0
ghcr.io/<owner>/agentlx:latest
```

Production documentation should keep using the pinned `v1.0.22` tag.
