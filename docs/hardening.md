...
- Pin Docker images to a version and digest, for example `ghcr.io/agentlx/agentlx:v1.0.12@sha256:c71b5581f96d86253fcf947c8b4f6e4f6582685c2cbafd235c6870d595063b9f`.
- Avoid `latest` in production.
- Check `/api/health` after deploy and confirm `resourceLimitEnforcement.status` is `ok`.
